...
export function AddAgentListItem() {
  return (
    <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all border border-dashed border-border/40 hover:border-border/70 hover:bg-surface-2/40 group">

...
import { Filter, Plus, MonitorPlay } from "lucide-react";
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col overflow-hidden bg-background">
          <PageHeader
            ...
            title="AI Agents"
            subtitle="Manage your CLI agents, their configs, MCPs & flags"
            actions={
              <>
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className="w-[280px] border-r border-border/60 flex flex-col bg-surface-2/30">
              <div className="p-3 flex items-center justify-between border-b border-border/40">
                ...
                <button className="text-txt-3 hover:text-foreground text-[10px] font-medium flex items-center gap-1">

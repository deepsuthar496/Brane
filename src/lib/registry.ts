...
export function getRegistryUrls(repo: string) {
  ...
  return {
    ...
    agentstore: { cdn: `${baseUrl}/agentstore/index.json`, fallback: `${fallbackUrl}/agentstore/index.json` },
    agentDetail: (id: string) => ({ cdn: `${baseUrl}/agentstore/${id}.json`, fallback: `${fallbackUrl}/agentstore/${id}.json` })
  };
}
